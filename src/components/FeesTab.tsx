                            ...
                            feePayments.length>0 && React.createElement('div',{className:"space-y-1"},
                                React.createElement('div',{className:"flex gap-1"},
                                    ...
                                    React.createElement('button',{
                                        ...
                                        onClick:()=>printAllPayments(fee, feePayments, linkedCase?.title||'غير معروفة', fee.client_name||linkedClient?.full_name||''),
                                ...
                                : React.createElement('div',{className:"flex gap-2"},
                                    ...
                                    React.createElement('button',{
                                        onClick:()=>{
                                            ...
                                            const registeredClient = fee.client_id ? clients.find(cl=>cl.id===fee.client_id) : null;
                                            setEditId(fee.id);
                                            setForm({
                                                case_id:fee.case_id,
