...
function SessionCard({ s, cases, clients, onOpenCase }: any) {
    ...
    return React.createElement('div', {
        className: "bg-premium-card rounded-lg px-2.5 py-1.5" + (linkedCase ? " cursor-pointer active:scale-[0.98] transition-all" : ""),
