...
function CalendarTab({ cases, clients, onOpenCase }: any) {
        ...
        selectedDay && React.createElement('div', { className: "space-y-2 fade-in" },
            ...
            daysSessions.length === 0
                ...
                : daysSessions.map((s: any) =>
                    React.createElement(SessionCard, { key: s.id, s, cases, clients, onOpenCase, onGoogleExport: handleExportToGoogle })
                )
        )
    );
}
