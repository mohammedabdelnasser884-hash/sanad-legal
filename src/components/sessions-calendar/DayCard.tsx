...
function DayCard({ dayName, dayNum, monthName, isToday, isFriday, sessCount, isConflict, daySess, dayTasks, cases, clients, onOpenCase, onOpenReminders, handleGoogleExport }: any) {
