...
function App() {
    ...
    const CasesTabContent   = React.createElement(CasesTab, {
        ...
        casesTotal, casesLoading, fetchCases, setShowCaseModal, setSelectedCase,
    ...
    return React.createElement('div', { className: 'h-full flex flex-col bg-premium-bg' },
        ...
        React.createElement('main', {
            ...
            tab === 'fees' && React.createElement('div', { className: 'space-y-4 fade-in' },
                React.createElement('div', { className: 'flex items-center justify-between' },
                    React.createElement('h3', { className: 'text-sm font-black text-white' }, '💰 نظام الأتعاب'),
                    React.createElement('button', {
                        onClick: () => setShowFeesSummary(true),
