...
declare global {
  interface Window {
    ...
    __dbWrite: (op: {
      ...
      knownUpdatedAt?: any;
      returning?: boolean;
    }) => Promise<{ error: any; offline?: boolean; queued?: boolean; data?: any; conflict?: boolean }>;
  }
...
(window as any).__dbWrite = async function({ type, table, data, id, knownUpdatedAt, returning }: any) {
    if (navigator.onLine) {
        try {
            let error = null;
